...
> [Youenn Piolet](<>)
> _Cloud engineer & DevOps, Team "Fondation"_
> Github: uZer
...
> _Most of the latency is introduced by the streaming protocols: Icecast,
> HLS..._
...
_Useful for Liquidsoap resilience_
...
_Useful for accessibility, loadbalancing, SLA..._
...
- Service availability (_Is Liquidsoap running?_)
- Input status (_Do we receive our audio sources?_)
- Output status (_Can we produce audio?_)
- Logs
- Network metrics (_Bandwidth usage, latency, jitter..._)
- System metrics (_CPU, memory..._)
- Pipeline metrics (_Buffers, latency, clocks..._)
- Audio metrics (_LUFS levels, is the audio blank?_)
...
- Autofallback loop in Liquidsoap (_as shown previously_)
...
- More templating, maybe for a more _common_ usage
- Extensive documentation
- Known issues (see `CHANGELOG.md`)
- New Grafana dashboards
- Inform Tony I'm using https://datafruits.fm to feed my examples _before_ the
